...
public class ScoreBreakdown_26
{
    public Breakdown blue { get; set; }
    public Breakdown red { get; set; }
}

public class Breakdown_26 //to be nabbed from TBA's website
{
